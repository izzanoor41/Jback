...
export default function SelectTeam({ session }: { session: any }) {
  ...
  return (
    <>
      <div className="p-4">
        <DropdownMenu>
          <DropdownMenuTrigger className="text-white border border-emerald-600 w-full p-2.5 rounded-md flex items-center justify-between text-xs font-medium hover:border-emerald-400 hover:bg-emerald-800/50">
