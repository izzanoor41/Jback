          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              <div className="flex items-center gap-2 mb-4">
                ...
                <Button size="sm" disabled={summarizing} variant={activeSentiment === "positive" ? "dark" : "outline"} onClick={() => handleSummarize("positive")}>
                  Positive
                </Button>
                <Button size="sm" disabled={summarizing} variant={activeSentiment === "neutral" ? "dark" : "outline"} onClick={() => handleSummarize("neutral")}>
                  Neutral
                </Button>
                <Button size="sm" disabled={summarizing} variant={activeSentiment === "negative" ? "dark" : "outline"} onClick={() => handleSummarize("negative")}>
                  Negative
                </Button>
              </div>
