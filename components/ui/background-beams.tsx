    ...
    <div className={cn("absolute h-full w-full inset-0 [mask-size:40px] [mask-repeat:no-repeat] flex items-center justify-center", className)}>
      ...
      >
        <path
          ...
          stroke="url(#paint0_radial_jback)"
          strokeOpacity="0.05"
          strokeWidth="0.5"
        ></path>
        ...
        <defs>
          {paths.map((path, index) => (
            ...
            >
              ...
              <stop offset="32.5%" stopColor="#059669"></stop>
              <stop offset="100%" stopColor="#047857" stopOpacity="0"></stop>
            </motion.linearGradient>
          ))}

          <radialGradient
            id="paint0_radial_jback"
            cx="0"
            cy="0"
            r="1"
          ...
          >
            <stop offset="0.0666667" stopColor="#10B981"></stop>
            <stop offset="0.243243" stopColor="#059669"></stop>
            <stop offset="0.43594" stopColor="#047857" stopOpacity="1"></stop>
          </radialGradient>
        </defs>
      </svg>
    </div>
